            ...
            <div class="col-sm-12 col-lg-9">
                <div class="form-area">
                    ...
                    <form id="inline-validation" class="form-horizontal form-stripe"
                        action="{{ route('tourist_attraction_update', $touristAttraction->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control"
                                value="{{ $touristAttraction->title ?? '' }}">
                        </div>
                        <div class="form-group">
                            <label for="textareaMaxLength" class="control-label">Content</label>
                            <textarea class="form-control" name="content" rows="3" id="textareaMaxLength">{{ $touristAttraction->content ?? '' }}</textarea>
                        </div>
                        <div class="form-group">
