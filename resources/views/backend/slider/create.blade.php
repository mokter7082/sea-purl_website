        ...
        <div class="row animated fadeInUp">
            <div class="col-sm-12 col-lg-9">
                <div class="form-area">
                    ...
                    @endif
                    <form id="inline-validation" class="form-horizontal form-stripe" action="{{ route('slider.store') }}"
                        ...
                        <div class="form-group">
                            <label for="textareaMaxLength" class="control-label">Description (optional)</label>
