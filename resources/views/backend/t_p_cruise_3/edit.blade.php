            ...
            <div class="col-sm-12 col-lg-9">
                <div class="form-area">
                    ...
                    <form id="inline-validation" class="form-horizontal form-stripe"
                        action="{{ route('t_p_cruise_3_update', $tourPackCruise3Edit->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control"
                                value="{{ $tourPackCruise3Edit->title ?? '' }}">
                        </div>
                        <div class="form-group">
                            <label for="price_foreigner">Content </label>
                            <textarea class="ckeditor form-control" name="content">{{ $tourPackCruise3Edit->content ?? '' }}</textarea>
                        </div>
