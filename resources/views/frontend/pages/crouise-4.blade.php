            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="about-two__right">
                        ...
                        <div class="wrapper">
                            <div class="section-title_ text-left_">
                                <h2 class="section-title__title pt-3">FEATURES</h2>
                            </div>
                            <ul>
                                <li> Fully air-conditioned</li>
                                <li>With/ without attached bathroom</li>
                                <li> Restaurant with a buffet station</li>
                                <li>Conference room with movie theatre</li>
                            </ul>
                        </div>
                        <div class="wrapper">
                            <div class="section-title_ text-left_">
                                <h2 class="section-title__title">Cabin Specification</h2>
                            </div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"> No# of Cabins</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Deluxe Twin Cabin (AC) </td>
                                        <td>2 Separate Single Beds</td>
                                        <td>06</td>
                                    </tr>
                                    <tr>
                                        <td>Deluxe Triple Cabin (AC)</td>
                                        <td>3 Separate Single Beds</td>
                                        <td>02</td>
                                    </tr>
                                    <tr>
                                        <td>Deluxe Double Cabin (AC)</td>
                                        <td>1 Double Bed</td>
                                        <td>02</td>
                                    </tr>
                                    <tr>
                                        <td>Super Deluxe Double Cabin (AC) with attached bathroom</td>
                                        <td>1 double bed </td>
                                        <td>10</td>
                                    </tr>
                                    <tr>
                                        <td>Family Cabin (AC) with attached</td>
                                        <td>1 double bed </td>
                                        <td>01</td>
                                    </tr>
                                </tbody>
                        ...
                        <section>
                            <div class="cruise_3_layout_img">
                                <img class="w-100" src="{{ asset('public/frontend/img/cruise-4.jpeg') }}" alt="">
                            </div>
                        </section>
