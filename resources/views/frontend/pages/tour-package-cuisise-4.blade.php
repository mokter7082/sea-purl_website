                ...
                <div class="about-two__right">
                    <div>
                        ...
                        <div>
                            ...
                            <p>3 Days/ 2 Nights</p>
                            <p>Price starts from BDT 16,000 per person</p>
                        </div>
                    </div>
                    <div class="wrapper">
                        <div class="section-title_ text-left_">
                        ...
                        <ul>
                            ...
                            <li>Reach Harbaria Eco Tourism center in the late afternoon. Hiking in the Harbaria forest area
                                to see
                                wild life and forest and have the first experience of Sundarban Mangrove Forest.</li>
                            <li>Back to the boat and immediately boat will start cruising for Kochikhali. Reach Kochikhali
                                at night and
                    ...
                    <div class="wrapper">
                        ...
                        <ul>
                            <li>Early in the morning we shall offer trip through small creeks and canals by country boat to
                                ...
                                Kochikhali forest
                                area to see wildlife Sanctuary, where you will encounter a lot of wildlife.</li>
                            <li>Back to the ship and have breakfast.</li>
                            <li>After breakfast we will visit Dimerchor sea beach. We will offer some event at sea beach.
                            </li>
                            <li>Return to the ship and start for Kotka. We will go through a small river where you will be
                                able to feel
                                Sundarban from a close distance. Lunch will be served on the way.</li>
                            <li>Reach Kotka in the afternoon, around 3.00pm we visit Kotka Tiger hill and hike in the jungle
                                for some
                                time. After visit tiger hill we will go for Jamtola watch tower.</li>
                            <li>Start our return journey toward Chadpai forest station in the evening. Overnight stay on the
                                ship near
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>3-6 Years</td>
                                <td>7,000 Tk Per Child</td>
                            </tr>
                            <tr>
                                <td>7-10 Years</td>
                                <td>9,500 Tk Per Child</td>
                            </tr>
                        </tbody>
                    </table>
